...
.button2 {
  ...
  cursor: pointer;
  transition: color 100ms ease, background-position-x 500ms ease;
  background: linear-gradient(90deg, rgba(0, 0, 0, 0.15) 60%, transparent);
...
.button2:hover .lambda.blue,
.button2.active .lambda.blue {
  filter: invert(0.4) sepia(1) hue-rotate(180deg) saturate(1.9);
}

.button2:hover .lambda.green,
.button2.active .lambda.green {
