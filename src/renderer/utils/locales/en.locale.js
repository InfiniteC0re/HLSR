export default {
  ...
  "#ERROR_NO_WRITE_PERMISSIONS":
    "HLSR has no permissons to write in the choosen folder!",
  ...
  "#REMOVE_GAMES_TO_CHANGE":
    "You can change the path only when no games are installed",
  "#SHORTCUT_LAUNCH": "Launch",
  "#UI_FOUND_CYRILLIC":
    "Found cyrillic symbols in game path. Work is not guaranteed",
  "#UI_FOUND_CYRILLIC_HINT":
    "Recommended to reinstall the game on another path",
...
<li>Minor UI update in the script editor</li>
<li>Using axios instead of electron-dl</li>
<li>Using 7Z instead of Onezip</li>
<li>Removed unused modules</li>
</ul><br/>
<h4>Update from 06/14/2021 [v. 0.2.2]</h4>
<ul>
